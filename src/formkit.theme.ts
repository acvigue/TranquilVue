export default {
  ...
  'family:box': {
    decorator:
      'block relative h-5 w-5 mr-2 rounded from-transparent ring-1 ring-gray-400 peer-checked:ring-blue-500 text-transparent peer-checked:text-blue-500 peer-checked:bg-blue-500',
    decoratorIcon:
